...
parser.add_argument('--activation',        type = str,   default='PReLU', help='type of activation')
...
testloader =  torch.utils.data.DataLoader(image_datasets['val'], batch_size=16, shuffle=False, num_workers=4)
